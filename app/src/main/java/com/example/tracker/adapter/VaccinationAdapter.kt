...
class VaccinationAdapter(
    private val vaccinations: MutableList<Vaccination>
    ...
    override fun onBindViewHolder(holder: VaccinationViewHolder, position: Int) {
        ...
        holder.vaccinationDate.text =
            DateFormatter.toShortMonthFormat(vaccination.administeredDate)
    }

    override fun getItemCount(): Int = vaccinations.size

    // This is what LiveData will call when DB updates
